...
export default function CakeViewer3D() {
  ...
  return (
    <section
      id="3d-studio"
      className="relative py-24 sm:py-32 bg-[#0c0908] text-[#f5f5f0] overflow-hidden"
    >
      {/* 1px Gold Gradient Section Divider */}
      <div className="divider-gold-gradient absolute top-0 left-0" />

      {/* Ambient background glow */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#d4a359]/8 rounded-full blur-[160px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#c68642]/6 rounded-full blur-[140px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-14">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#d4a359]/35 bg-[#1b120c]/90 backdrop-blur-md shadow-lg mb-5">
          ...
          <p className="mt-3 text-sm sm:text-base text-[#e5dfd5] font-light max-w-xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          {/* 3D Canvas Column */}
          <div className="lg:col-span-7 bg-[#140e0a]/90 rounded-3xl border border-white/10 shadow-2xl overflow-hidden relative flex flex-col h-[520px] sm:h-[620px]">
            {/* HUD Status */}
            <div className="absolute top-4 left-4 right-4 z-20 flex items-center justify-between pointer-events-none">
              <div className="px-3.5 py-1.5 rounded-full bg-[#1b120c]/90 backdrop-blur-md border border-[#d4a359]/35 shadow-md flex items-center gap-2 text-xs font-semibold text-[#fffbf5]">
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-ping" />
                <span>Studio 3D View</span>
              </div>
              <button
                onClick={() => setAutoRotate(!autoRotate)}
                className="pointer-events-auto px-3.5 py-1.5 rounded-full bg-[#1b120c]/90 backdrop-blur-md border border-[#d4a359]/35 shadow-md text-xs font-medium text-[#f5cb88] hover:bg-[#251811] flex items-center gap-1.5 transition-colors cursor-pointer"
              >
            ...
            <div className="absolute bottom-3 left-0 right-0 text-center pointer-events-none z-10">
              <span className="text-[11px] font-medium text-[#f5cb88] bg-[#1b120c]/90 backdrop-blur-md px-4 py-1 rounded-full border border-white/10 shadow-md">
                Drag to rotate • Scroll to zoom 360°
              </span>
            </div>
          </div>

          {/* Dark Glassmorphic Customizer Panel on Right */}
          <div className="lg:col-span-5 bg-[#19110b]/75 backdrop-blur-xl rounded-3xl border border-white/10 p-6 sm:p-8 shadow-2xl flex flex-col gap-6">
            <div className="flex items-center justify-between pb-4 border-b border-white/10">
              <div>
                <span className="text-[10px] font-bold tracking-widest text-[#d4a359] uppercase">
                  Bespoke Studio
                </span>
              ...
              <div className="text-right">
                <span className="text-[10px] text-[#dcd7ce]/70 uppercase tracking-wider block font-medium">
                  Estimated Total
                </span>
                <span className="font-serif text-2xl font-bold text-[#f5cb88]">
                  ₹{totalPrice}
                </span>
              </div>
            </div>
            ...
            {/* 1. Tiers */}
            <div>
              <label className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#d4a359] mb-2.5">
            ...
            <div>
              <label className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-[#d4a359] mb-2">
            ...
            <div className="pt-2">
              <button
                onClick={handleOrder}
                className="w-full py-3.5 rounded-2xl btn-gold-gradient font-bold text-xs sm:text-sm tracking-wider uppercase flex items-center justify-center gap-2.5 shadow-xl cursor-pointer"
              >
                <ShoppingBag className="w-4 h-4" />
                <span>Order Custom 3D Cake • ₹{totalPrice}</span>
              </button>
              <div className="mt-2.5 flex items-center justify-center gap-3 text-[11px] text-[#dcd7ce]/70">
