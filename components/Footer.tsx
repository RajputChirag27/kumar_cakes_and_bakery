...
export default function Footer() {
  return (
    <footer className="relative bg-[#080504] border-t border-[#d4a359]/20 text-[#ebdccb] pt-16 pb-12 overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-[#d4a359]/4 blur-[180px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-xs text-[#ebdccb]/75 leading-relaxed mb-6">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-[#ebdccb]/80">
              <li>
          ...
          <div>
            ...
            <div className="space-y-3 text-xs text-[#ebdccb]/80">
              ...
              <p className="text-[11px] text-[#ebdccb]/60">
                Midnight celebration deliveries available with 6-hour prior notice across Hathras.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-xs text-[#ebdccb]/80">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-2 inline-flex items-center gap-2 px-4 py-2 rounded-xl btn-gold-gradient text-xs font-bold uppercase tracking-wider"
              >
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-[#ebdccb]/60">
